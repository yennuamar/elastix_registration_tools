...
if __name__=="__main__":
     IDs=open('/Volumes/RAPID_PROCESSING/registered_maps2/' + 'IDS_full.txt').read().split("\n")
     cid_list=[]
     BL_core_vol_list=[]
     BL_Tmax6_vol_list=[]
     BL_Tmax10_vol_list=[]
     ...
     BL_CBVindex_excluding_core_list=[]
...
#         input_folder='/Users/amar/D3_R47_RANDOMIZED_FINAL'
         input_folder='/Volumes/RAPID_PROCESSING/registered_maps2/'  
         output_folder='/Volumes/RAPID_PROCESSING/registered_maps_final/' 
         ...
         if not (os.path.exists(input_folder + cid)):
             ...
             BL_CBVindex_excluding_core_list.append("")
         ...
         if os.path.exists(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_rcbv_slice_merged.nii'):            
             ...
             BL_fontsize=50
             BL_indent=70
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_rcbv_slice_merged.nii',output_folder + cid + '/' + cid +'_' +'BL_rcbv_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_tmax_slice_merged.nii',output_folder + cid + '/' + cid +'_' +'BL_tmax_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_tmax_mask_merged.nii',output_folder + cid + '/' + cid +'_' +'BL_tmax_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_tmax6_mask_merged.nii',output_folder + cid + '/' + cid +'_' +'BL_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_core_mask_merged.nii',output_folder + cid + '/' + cid +'_' +'BL_core_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_rcbv_mask_outside_merged.nii',output_folder + cid + '/' + cid +'_' +'BL_outside_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_tissue_mask_merged.nii',output_folder + cid + '/' + cid +'_' +'BL_brain_mask.nii')
...
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_rcbv_slice_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_rcbv_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_tmax_slice_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_tmax_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_segm_mask_view1_Thresholded_Tmax_Parameter_View_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_tmax_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_segm_mask_view0_Thresholded_Tmax_Parameter_View_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_segm_mask_view0_Thresholded_core_Parameter_View_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_core_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_rcbv_mask_outside_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_outside_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL2NCCT_coregistration_tissue_mask_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_brain_mask.nii')
...
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL_rcbv_slice_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_rcbv_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL_tmax_slice_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_tmax_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL_segm_mask_view1_Thresholded_Tmax_Parameter_View_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_tmax_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL_segm_mask_view0_Thresholded_Tmax_Parameter_View_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL_segm_mask_view0_Thresholded_core_Parameter_View_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_core_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL_rcbv_mask_outside_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_outside_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'BL_tissue_mask_slab0.nii',output_folder + cid + '/' + cid +'_' +'BL_brain_mask.nii')
         ...
         if BL_flag==2:
             ...
             BL_CBVindex0= round(BL_CBVindex0, 3)
             BL_CBVindex1=round(BL_CBVindex1, 3)
             
             BL_CBVindex_excluding_core=np.mean(BL_rcbv_arr_norm[np.logical_and(np.logical_and(BL_tmax6_arr>0,BL_tissue_arr>0),np.logical_not(BL_core_arr>0))])
         ...
         BL_Tmax6_vol=round(BL_Tmax6_vol,3)
         BL_Tmax10_vol=round(BL_Tmax10_vol,3)
         BL_core_vol=round(BL_core_vol,3)
         ...
         try:
             BL_HPindex=round(BL_HPindex, 3)
         except: 
             BL_HPindex=str(BL_HPindex)
             
         try:   
             BL_CBVindex= round(BL_CBVindex, 3)
             BL_CBVindex_excluding_core=round(BL_CBVindex_excluding_core, 3)
         except:
             BL_CBVindex= str(BL_CBVindex)
             BL_CBVindex_excluding_core=str(BL_CBVindex_excluding_core)
         ...
         print('BL_CBVindex_excluding_core is '+ str(BL_CBVindex_excluding_core))
         ...
         input_folder2='/Volumes/RAPID_PROCESSING/D3_R47_RANDOMIZED_FINAL/'
         ...
         if os.path.isdir(input_folder2 +'/'+str(cid)+'/'+'BL/Results_PWI_DWI_R47/'):
            ...
            file = open("/Volumes/RAPID_PROCESSING/registered_maps2/BL_diff slicethickness.txt","a") 
...
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_rcbv_slice_merged.nii',output_folder + cid + '/' + cid +'_' +'FU_rcbv_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_tmax_slice_merged.nii',output_folder + cid + '/' + cid +'_' +'FU_tmax_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_tmax_mask_merged.nii',output_folder + cid + '/' + cid +'_' +'FU_tmax_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_tmax6_mask_merged.nii',output_folder + cid + '/' + cid +'_' +'FU_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_core_mask_merged.nii',output_folder + cid + '/' + cid +'_' +'FU_core_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_rcbv_mask_outside_merged.nii',output_folder + cid + '/' + cid +'_' +'FU_outside_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_tissue_mask_merged.nii',output_folder + cid + '/' + cid +'_' +'FU_brain_mask.nii')
...
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_rcbv_slice_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_rcbv_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_tmax_slice_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_tmax_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_segm_mask_view1_Thresholded_Tmax_Parameter_View_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_tmax_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_segm_mask_view0_Thresholded_Tmax_Parameter_View_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_segm_mask_view0_Thresholded_core_Parameter_View_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_core_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_rcbv_mask_outside_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_outside_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2NCCT_coregistration_tissue_mask_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_brain_mask.nii')
...
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2BL_coregistration_rcbv_slice_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_rcbv_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2BL_coregistration_tmax_slice_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_tmax_gray.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2BL_coregistration_tmax_mask_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_tmax_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2BL_coregistration_tmax6_mask_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2BL_coregistration_core_mask_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_core_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2BL_coregistration_rcbv_mask_outside_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_outside_tmax6_mask.nii')
#             shutil.copy2(input_folder + cid + '/' + cid +'_' +'FU2BL_coregistration_tissue_mask_slab0.nii',output_folder + cid + '/' + cid +'_' +'FU_brain_mask.nii')
             ...
             reperfusionpercent_list.append("")
             FU_HPindex_basedon_BLtmax6_list.append("")
             BL_CBVindex_excluding_core_list.append(BL_CBVindex_excluding_core)
             print(cid+ "doesn't have FU")
             continue
         ...
         if FU_flag==2:
             ...
             FU_CBVindex0= round(FU_CBVindex0, 3)
             FU_CBVindex1= round(FU_CBVindex1, 3)
             ...
             FU_CBVindex1=""
         try:
             FU_CBVindex= round(FU_CBVindex, 3)
         except:
         ...
         try:
             FU_HPindex_basedon_BLtmax6= round(FU_HPindex_basedon_BLtmax6, 3)
         except:
         ...
         FU_Tmax6_vol=round(FU_Tmax6_vol,3)
         FU_Tmax10_vol=round(FU_Tmax10_vol,3)
         FU_core_vol=round(FU_core_vol,3)
...
#         compositemask[compositemask==2]=1
         ...
         if os.path.isdir(input_folder2 +'/'+str(cid)+'/'+'FU/Results_PWI_DWI_R47/'):
            ...
            file = open("/Volumes/RAPID_PROCESSING/registered_maps2/FU_diff slicethickness.txt","a") 
...
#         temp=txt2vol([20,50],"CBV index orig: "+str(FU_CBVindex_orig)+"   Slab0 CBV index orig : "+str(FU_CBVindex0_orig)+"   Slab1 CBV index orig: "+str(FU_CBVindex1_orig),temp,FU_fontsize)
         ...
         reperfusionpercent=round(((BL_Tmax6_vol-FU_Tmax6_vol)/BL_Tmax6_vol)*100,3)   
...
names_list=["cid","BL_core_vol","BL_Tmax6_vol","BL_Tmax10_vol","BL_CBVindex","BL_HPindex","FU_core_vol","FU_Tmax6_vol","FU_Tmax10_vol","FU_CBVindex_basedon_BLtmax6","FU_HPindex","FU_HPindex_basedon_BLtmax6","reperfusionpercent","BL_CBVindex_excluding_core"]
workbook = xlsxwriter.Workbook("/Volumes/RAPID_PROCESSING/registered_maps2/"+'D3_registered_volumes_all.xlsx')
...
for row in range(len(cid_list)):
    ...
    worksheet.write(row+1, 13,BL_CBVindex_excluding_core_list[row])
    row += 1
    print(row)
