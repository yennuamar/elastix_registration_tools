...
class Transport:
    ...
    def parse_response(self, response):
        ...
        while 1:
            data = stream.read()
            if not data:
                break #happens too early perhaps??? how long is the data stream and how much did we get?
            if self.verbose:
...
if __name__ == "__main__":
   ...
   # server = Server("http://171.65.168.30:8080",verbose=True)
    ...
    server = Server("http://192.168.10.112:8080",verbose=False)
