...
if __name__=="__main__": 
    ...
    input_folder='/Users/icasdb/Desktop/'
    ...
    for cid in IDs:  #IDs:
        ...
        ncct_dcm_list=[]
        for file in glob.glob(input_folder+str(cid)+'/NCCT_TOPOK/*dcm'):
...
#        ncct_dcm_list.sort()
        ...
        sitk.WriteImage(ncct_out_image,input_folder+str(cid)+'/NCCT_TOPOK_tiltcorrected.nii')
